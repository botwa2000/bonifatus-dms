      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-neutral-900 dark:text-white mb-3">2.1 Strictly Necessary Cookies (Always Active)</h3>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-neutral-900 dark:text-white mb-3">2.2 Analytics Cookies (Optional)</h3>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
            ...
            <div className="bg-neutral-50 p-4 rounded mb-4">
              <p className="text-neutral-700 dark:text-neutral-300 mb-2"><strong>Provider:</strong> Google Analytics (if enabled)</p>
              <p className="text-neutral-700 dark:text-neutral-300 mb-2"><strong>Purpose:</strong> Website usage analytics</p>
              <p className="text-neutral-700 dark:text-neutral-300 mb-2"><strong>Data collected:</strong> Page views, session duration, bounce rate (anonymized)</p>
              <p className="text-neutral-700 dark:text-neutral-300"><strong>Data retention:</strong> 26 months</p>
            </div>

            <h3 className="text-xl font-semibold text-neutral-900 dark:text-white mb-3">2.3 Functionality Cookies (Optional)</h3>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">4. Managing Your Cookie Preferences</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
              You have several options to manage or delete cookies:
            </p>

            <h3 className="text-xl font-semibold text-neutral-900 dark:text-white mb-3">4.1 Cookie Consent Banner</h3>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-neutral-900 dark:text-white mb-3">4.2 Browser Settings</h3>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-neutral-900 dark:text-white mb-3">4.3 Do Not Track (DNT)</h3>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">5. Cookie Lifespan</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">6. Changes to This Cookie Policy</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">7. More Information</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">9. Useful Resources</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
