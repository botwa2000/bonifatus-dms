  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold text-neutral-900 mb-8">About Bonifatus DMS</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 mb-4">What Makes Us Different</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-neutral-900 mb-3">AI-Powered Intelligence</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-neutral-900 mb-3">User-Friendly Design</h3>
                <p className="text-neutral-700">
                  Intuitive interface designed for both tech-savvy professionals and everyday users.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-neutral-900 mb-3">Scalable Solution</h3>
                <p className="text-neutral-700">
