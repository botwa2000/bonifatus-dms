      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-neutral-900 dark:text-white mb-3">1.2 Automatically Collected Information</h3>
            <ul className="list-disc pl-6 text-neutral-700 dark:text-neutral-300 space-y-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">3. Third-Party Service Providers</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
              We use the following third-party services to operate our platform. Each has their own privacy policy:
            </p>

            <h3 className="text-xl font-semibold text-neutral-900 dark:text-white mb-3">3.1 Google Services</h3>
            <ul className="list-disc pl-6 text-neutral-700 dark:text-neutral-300 space-y-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">4. Data Storage and Security</h2>
            <ul className="list-disc pl-6 text-neutral-700 dark:text-neutral-300 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">5. Data Retention</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">6. Your Privacy Rights</h2>

            <h3 className="text-xl font-semibold text-neutral-900 dark:text-white mb-3">6.1 GDPR Rights (European Users)</h3>
            <ul className="list-disc pl-6 text-neutral-700 dark:text-neutral-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-neutral-900 dark:text-white mb-3">6.2 CCPA Rights (California Residents)</h3>
            <ul className="list-disc pl-6 text-neutral-700 dark:text-neutral-300 space-y-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">8. International Data Transfers</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">9. Children&apos;s Privacy</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">10. Data Breach Notification</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">11. Do Not Track Signals</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">12. Changes to This Privacy Policy</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">13. Contact Information</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">14. Supervisory Authority</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
