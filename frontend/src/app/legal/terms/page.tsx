    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 mb-4">3. Account Terms</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 mb-4">4. Free Trial Terms</h2>
            <ul className="list-disc pl-6 text-neutral-700 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 mb-4">5. Privacy and Data Protection</h2>
            <p className="text-neutral-700 mb-4">
