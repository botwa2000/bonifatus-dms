...
class TestGoogleOAuth:
    ...
    def test_google_callback_success(self, client, test_db_session, mock_google_oauth):
        ...
        with patch("src.api.auth.GoogleOAuthService") as mock_oauth_class, patch(
            "src.api.auth.AuthService"
        ) as mock_auth_class, patch("src.api.auth.GoogleDriveClient"):
            ...
            mock_auth_service.create_user_tokens.return_value = (
                "access_token",
                "refresh_token",
            )
            ...
            response = client.post(
                ...
                json={"code": "test_auth_code", "state": "test_state_123"},
            )
