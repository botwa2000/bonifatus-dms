...
class GoogleOAuthService:
    ...
    def __init__(self):
        ...
        self.redirect_uri = settings.google.google_redirect_uri or "http://localhost:3000/auth/callback"
    ...
    def cleanup_expired_states(self) -> int:
        ...
        try:
            ...
            if expired_states:
                logger.info(f"Cleaned up {len(expired_states)} expired state parameters")
