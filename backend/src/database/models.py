...
class Document(Base):
    ...
    ai_confidence_score = Column(Float, nullable=True)  # Confidence in categorization (0.0-1.0)
...
class UserSettings(Base):
    ...
    sync_frequency_minutes = Column(Integer, default=60, nullable=False)  # Auto-sync interval
    ...
    default_view_mode = Column(String(20), default="grid", nullable=False)  # grid, list, timeline
    ...
    improve_ai_enabled = Column(Boolean, default=True, nullable=False)  # Use data to improve AI
...
class SystemSettings(Base):
    ...
    premium_monthly_uploads = Column(Integer, default=0, nullable=False)  # 0 = unlimited
    ...
    google_api_rate_limit = Column(Integer, default=100, nullable=False)  # requests per minute
...
class AuditLog(Base):
    ...
    # Event details
    action = Column(String(100), nullable=False)  # e.g., 'document_upload', 'login', 'category_create'
    resource_type = Column(String(50), nullable=True)  # e.g., 'document', 'user', 'category'
